...
ninja.data = [{
    ...
    handler: () => {
      ...
      handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-i-received-funding-from-tsinghua-university-s-huiyan-fund-only-10-people-in-the-entire-school-salary-type-fund-300-000-rmb-per-year-two-years-star2",
          title: 'I received funding from Tsinghua University’s Huiyan Fund (only 10 people in the...',
          description: "",
          section: "News",},{id: "news-my-paper-titled-dual-pronged-deep-learning-preprocessing-on-heterogeneous-platforms-with-cpu-accelerator-and-csd-has-been-accepted-by-ieee-transactions-on-computers-ccf-a",
          title: 'My paper titled “Dual-Pronged Deep Learning Preprocessing on Heterogeneous Platforms with CPU, Accelerator...',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%77%65%69%6A%69%61%34%34%37%33@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/Weigaa", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/jia-wei-4747512a4", "_blank");
        },
      },{
        id: 'social-orcid',
        title: 'ORCID',
        section: 'Socials',
        handler: () => {
          window.open("https://orcid.org/0000-0002-2234-0378", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=zBa1_PIAAAAJ", "_blank");
        },
      },{
      id: 'light-theme',
